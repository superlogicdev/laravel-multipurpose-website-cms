                	...
                	<div class="col-md-12">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-dark">{{clean( trans('niva-backend.sidebar_header') , array('Attr.EnableID' => true))}}</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="sidebar_description" class="form-control" rows="6">{{$setting->sidebar_description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
