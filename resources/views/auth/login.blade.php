                            ...
                            <div class="p-5">
                                <div class="text-center">
                                 ...
                                 <form method="POST" action="{{ route('login') }}" class="user">
                                    ...
                                    <div class="form-group">
                                        <input id="password" placeholder="Password" type="password" id="exampleInputPassword"  class="form-control form-control-user @error('password') is-invalid @enderror" name="password" value="" required autocomplete="current-password">
